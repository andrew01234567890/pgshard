...
pub use pgoutput::{
    ...
    PgOutputEncoding, PgOutputEncodingError, PgOutputError, PgOutputInsert, PgOutputLogicalMessage,
    PgOutputMessage, PgOutputOldTuple, PgOutputOrigin, PgOutputPrepared, PgOutputRelation,
