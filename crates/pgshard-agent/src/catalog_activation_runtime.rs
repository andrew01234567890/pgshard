...
mod tests {
    ...
    use crate::catalog_materialization_program::{
        CatalogMaterializationProgram, compile_catalog_materialization_program,
    };
    use crate::writable::{
    ...
    /// The binding is indifferent to the program's contents; it only carries
    /// it. These fragments are the minimal shapes the compiler accepts.
    fn fixture_program() -> CatalogMaterializationProgram {
