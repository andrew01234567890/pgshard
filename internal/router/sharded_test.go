...
func newShardedHarnessShards(t testing.TB, cfg Config, shards int, opts ...func(*harness)) *shardedHarness {
	...
	startHarness(t, h, Config{Snapshot: h.snap, Poolers: pl, Logger: slog.New(slog.DiscardHandler), Scatter: cfg.Scatter, Decisions: cfg.Decisions, CrossShardLockTimeout: cfg.CrossShardLockTimeout, Sequences: cfg.Sequences, Planner: cfg.Planner, Migrations: cfg.Migrations, RefreshSnapshot: cfg.RefreshSnapshot, CatalogAccess: cfg.CatalogAccess,
