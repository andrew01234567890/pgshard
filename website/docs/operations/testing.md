...
the lock-free cache without a manual read, ignores a malformed hint, recovers a
trigger-bypassed epoch through polling, shuts down cleanly, and treats forced
connection loss as terminal. A separate raw-wire PostgreSQL 18 test validates
