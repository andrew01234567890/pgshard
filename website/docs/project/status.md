...
| Pooling and SQL routing | Bounded zero-copy PostgreSQL 18 frontend frame decoder, fail-closed bound-parameter routing core with exact canonical hashing, and standalone framing/routing microbenchmarks; no listening endpoint, TLS/authentication, SQL parser, statement planner, or connection pool | Partial |
