...
| Pooling and SQL routing | Bounded zero-copy PostgreSQL 18 frontend frame plus selected simple/extended query-body decoders, bounded stack-protected conservative PostgreSQL-dialect syntax parsing with a live PostgreSQL 18 DML differential, fail-closed bound-parameter routing core with exact canonical hashing, and standalone framing/bind/parser/routing microbenchmarks; no listening endpoint, TLS/authentication, semantic route planner, or connection pool | Partial |
