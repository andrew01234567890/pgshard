...
| Admin UI, Prometheus and OpenTelemetry | Pooler catalog Prometheus exposition exists in source; scraping resources, SQL-path metrics, OpenTelemetry export, dashboards, UI, and Grafana/Tempo validation are absent | Partial |
