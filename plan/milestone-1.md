...
the Rust cache validates and hashes identity, placement generation, and current
physical target. A
eligible populated v0.49 catalog upgrades once without changing range ownership;
live routes to unavailable physical cells must be repaired or retired with the
