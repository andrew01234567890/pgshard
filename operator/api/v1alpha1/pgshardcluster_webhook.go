...
// +kubebuilder:webhook:path=/mutate-pgshard-io-v1alpha1-pgshardcluster,mutating=true,failurePolicy=fail,sideEffects=None,groups=pgshard.io,resources=pgshardclusters,verbs=create;update,versions=v1alpha1,name=mpgshardcluster.kb.io,admissionReviewVersions=v1
// +kubebuilder:webhook:path=/validate-pgshard-io-v1alpha1-pgshardcluster,mutating=false,failurePolicy=fail,sideEffects=None,groups=pgshard.io,resources=pgshardclusters,verbs=create;update,versions=v1alpha1,name=vpgshardcluster.kb.io,admissionReviewVersions=v1
