...
func newActivationPublicationFixture(t *testing.T) *activationPublicationFixture {
	...
	request := &pgshardv1alpha1.CatalogActivationRequest{
		...
		Materials: pgshardv1alpha1.CatalogActivationMaterials{
			...
			MigrationSHA256:         document.Materialization.ShardschemaMigration.SHA256, ShardCount: document.Materialization.ShardCount, InventorySHA256: document.Materialization.ShardInventory.SHA256,
			GenesisSHA256: document.Materialization.DatabaseGenesis.SHA256, PreflightSHA256: document.Materialization.DatabaseTopologyPreflight.SHA256,
